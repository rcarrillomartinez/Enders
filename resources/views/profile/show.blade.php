                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        @if (session('user_type') === 'viajero')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $user->apellido1 ?? '' }}" disabled>
                            </div>

                            <div class="mb-3">
                                <label for="ciudad" class="form-label">Ciudad</label>
                                <input type="text" class="form-control" value="{{ $user->ciudad ?? '' }}" disabled>
                            </div>
                        @elseif (session('user_type') === 'hotel')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre_hotel" name="nombre_hotel" value="{{ $user->nombre_hotel ?? '' }}">
                            </div>
